...
export const createIncident = async(req, res) => {
    //return res.send('Criando um incident')
...
export const getAllIncidents = async(req, res) => {
    //return res.send('Todos os incidentes');
...
export const getMyIncident = async(req, res) => {
    //return res.send('Meus incidentes');
...
export const updateIncident = async(req, res) => {
    //return res.send('Atualiza incidente')
...
export const deleteIncident = async(req, res) => {
    //return res.send('Deleta incidente');
    ...
    try {
        ...
        if(incident.status === 'aberto' || incident.status === 'em processo'){
            return res.status(404).json({ errors: ['Não é possível deletar o incidente em aberto antes de reolve-lo'] })
        }
