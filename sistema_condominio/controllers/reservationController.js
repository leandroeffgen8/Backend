...
export const createReservation = async(req, res) => {
    //return res.send('Criando reserva')
...
export const getAllReservations = async(req, res) => {
    //return res.send('Todas as reservas');
...
export const getMyReservation = async(req, res) => {
    //return res.send('Minhas reservas');
...
export const updateReservation = async(req, res) => {
    //return res.send('Atualiza reserva');
...
export const deleteReservation = async(req, res) => {
    //return res.send('Deleta reserva');
